  ...
  const videoData = [
    {
      ...
      videoSrc: `${process.env.NEXT_PUBLIC_VIDEO_SERVICE_URL}/videos/Junior-Garcia.mp4`,
    },
    {
      ...
      videoSrc: `${process.env.NEXT_PUBLIC_VIDEO_SERVICE_URL}/videos/Pranav-Shah.mp4`,
    },
    {
      ...
      videoSrc: `${process.env.NEXT_PUBLIC_VIDEO_SERVICE_URL}/videos/Turiska-Nolan.mp4`,
    },
    {
      ...
      videoSrc: `${process.env.NEXT_PUBLIC_VIDEO_SERVICE_URL}/videos/Michael-Chandler.mp4`,
    },
    {
      title: "Piano Moving",
      ...
      videoSrc: `${process.env.NEXT_PUBLIC_VIDEO_SERVICE_URL}/videos/Emran-Khan.mp4`,
    },
    {
      ...
      videoSrc: `${process.env.NEXT_PUBLIC_VIDEO_SERVICE_URL}/videos/Catheriner-Smith.mp4`,
    },
  ];
