...
const ServicesCard = () => {
  const services:any = [
  {
    ...
    image: `${process.env.NEXT_PUBLIC_IMAGE_SERVICE_URL}residential-service-card.webp`,
  ...
  },
 {
  ...
  },
  {
    ...
    image: `${process.env.NEXT_PUBLIC_IMAGE_SERVICE_URL}cross-country-service-cards.webp`,
