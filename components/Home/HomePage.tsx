...
const slides = [
  {
    id: 1,
    image:
      `${process.env.NEXT_PUBLIC_IMAGE_SERVICE_URL}banner.webp`,
  ...
  },
  {
    id: 2,
    image:
      `${process.env.NEXT_PUBLIC_IMAGE_SERVICE_URL}why-choose-goldstar.webp`,
  ...
  },
  {
    id: 4,
    image:
      `${process.env.NEXT_PUBLIC_IMAGE_SERVICE_URL}junk-removal-banner.webp`,
  ...
  },
  {
    id: 5,
    image:
      `${process.env.NEXT_PUBLIC_IMAGE_SERVICE_URL}demolition-service.webp`,
